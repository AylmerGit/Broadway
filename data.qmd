...
<span style="color:blue;">Statistics.Gross Potential:</span> This is a percentage of gross total made in the week over the possible total made in the week. In the <br>
<span style="color:blue;">Statistics.Performances:</span> Number of performances that occured during that week<br>

```{r}
colnames(BroadwayData)
```
